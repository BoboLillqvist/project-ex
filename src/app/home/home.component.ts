...
export class HomeComponent implements OnInit {
  ...
  examWork3 = new ExamWork("MobileRobotic Telepresence2","Örebro",["C","Van att jobba i linuxmiljö"],["C++"],"Ebjudande om examensarbete: hej hejhejhejj Mobile", new Date("2018-08-20"),"5 dagar i veckan",new Person("Sven","Svensson","Sven_Svensson@yahoo.se","073-4334255"),"nånting",new Company("MRTRP","hurrdurr","www.mobilerobotics.com/about",[this]));

  //läs in examensarbeten från databas
  examWorks = [this.examWork1,this.examWork2,this.examWork3];
